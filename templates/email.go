        ...
        <div class="order-details">
            ...
            <table class="data-table">
                <tr>
                    ...
                    <th colspan="8" style="text-align:center;vertical-align:middle;">PO Details</th>
                ...
                <tr>
                    ...
                    <th>Quantity</th>
                    <th>Amount</th>
                    <!-- LR Number and Appointment Date are covered by rowspan above -->
                    <th>Quantity</th>
                    <th>Weight</th>
                    <th>Dimensions (L x B x H)</th>
                    <th>Number</th>
...
const SendBulkAppointmentEmailTemplate = `
<html>
    <head>
        <style>
            body { font-family: Arial, sans-serif; color: #333; line-height: 1.5; margin: 0; padding: 20px; }
    ...
    <body>
        <p>Hello %s Team,</p>
        <p>This is to inform you about the Delivery schedule for the following order(s):</p>
